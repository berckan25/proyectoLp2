...
<body>
			...
			<div class="container">
				<div class="signup-content">
						...
						<form method="post" action="register" class="register-form"
							...
							<div class="form-group">
								<input type="checkbox" name="agree-term" id="agree-term"
									...
									class="label-agree-term"><span><span></span></span>Estoy
									de acuerdo en los <a href="#" class="term-service">Terminos
					...
					<div class="signup-image">
						<figure>
							<img src="images/registro.png" alt="sing up image">
						</figure>
						<a href="login.jsp" class="signup-image-link">Ya soy
							miembro</a>
					</div>
				</div>
			</div>
	...
	<script type="text/javascript">
		...
		if (status == "invalidTelefono") {
			swal("Congrats","Account Created Successfully","error");
		}
		if (status == "InvalidTelefonoLength") {
			swal("Congrats","Mobile Number Should be of 10 digit","error");
		}
		if (status == "invalidConfirmPassword") {
			swal("Congrats","Pasword do not match","error");
		}
	</script>
